...
<body>
	<div class="clgj_nr">
        ...
        <c:choose>
        	...
        	<form id="kitchen" action="/designerMeasureTools/three/saveDrawingAndDiningRoom/${orderNoStr}" method="post">
        <ul>
        	<li>
            ...
            <li>
            	<h2>空调 </h2>
                <div class="clgj_xz">
                <input id="ktdk_yes" class="input_yes" name="12" type="radio" value="挂机">
                <label for="ktdk_yes">挂机</label>
                <input id="pwdd_no"  class="input_no" name="12" type="radio" value="柜机">
                <label for="ktdk_no">柜机</label>	
                <input type="hidden" name="txtValue"  value="">
	            <input type="hidden" name="name"  value="空调 ">
	            <input type="hidden" name="firstValue"  value="挂机">
	            <input type="hidden" name="secondValue"  value="柜机">
	            <input type="hidden" name="required"  value="0">
	            <input type="hidden" name="elementType"  value="0">
             ...
             <li>
            	<h2>空调 是否需要打孔</h2>
                <div class="clgj_xz">
                <input id="ktdk_yes" class="input_yes" name="13" type="radio" value="是">
                <label for="ktdk_yes">是</label>
                <input id="pwdd_no"  class="input_no" name="13" type="radio" value="否">
                <label for="ktdk_no">否</label>	
                <input type="hidden" name="txtValue"  value="">
	            <input type="hidden" name="name"  value="空调 是否需要打孔 ">
	            <input type="hidden" name="firstValue"  value="是">
	            <input type="hidden" name="secondValue"  value="否">
	            <input type="hidden" name="required"  value="0">
	            <input type="hidden" name="elementType"  value="0">
            ...
            <li>
            	<h2>个性化墙面  </h2>
                <div class="clgj_xz">
                    <input id="qm_yes" class="input_yes" name="14" type="radio" value="有">
                    <label for="qm_yes">有</label>
                    <input id="qm_no" class="input_no" name="14" type="radio" value="无">
            ...
            <li>
            	<h2>客厅电视是否壁挂 </h2>
                <div class="clgj_xz">
                    <input id="dsbg_yes" class="input_yes" name="15" type="radio" value="挂">
                    <label for="dsbg_yes">挂</label>
                    <input id="dsbg_no" class="input_no" name="15" type="radio" value="不挂">
                    <label for="dsbg_no">不挂</label>	
                    <input type="hidden" name="txtValue"  value="">
	            	<input type="hidden" name="name"  value="客厅电视是否壁挂 ">
       ...
       <form id="drawingAndDining" action="/designerMeasureTools/three/updateDrawingAndDiningRoom/${orderNoStr}" method="post">
        <ul>
        	<li>
            	<h2>个性化吊顶 <span>★</span></h2>
                <div class="clgj_xz">
                ...
                <div id="clgj_dd" class="clgj_tx">
                	<span>预算金额</span>
                    <input name="note" type="text" placeholder="元" value="${ erpPaileiDetailsList[0].note}" >
                </div>
            </li>
            <li>
            	<h2>个性化弱电 <span>★</span></h2>
                ...
                <div class="clgj_tx">
                	<span>预算金额</span>
                    <input name="note" type="text" placeholder="元" value="${ erpPaileiDetailsList[1].note}">
                </div>
            </li>
            <li>
            	<h2>家具 <span>★</span></h2>
            ...
            <li>
                ...
                <div id="clgj_sk" class="clgj_tx">
                	<span>预算金额</span>
                    <input name="note" type="text" name="note" placeholder="元" value="${ erpPaileiDetailsList[3].note}">
                </div>
            </li>
            <li>
            	<h2>地面材质  <span>★</span></h2>
            ...
            <li>
                ...
                <div id="clgj_sys" class="clgj_tx">
                	<span>预算金额</span>
                    <input name="note" type="text" placeholder="元" value="${ erpPaileiDetailsList[6].note}">
                </div>
            </li>
            <li>
            	<h2>个性化窗帘盒 <span>★</span></h2>
                ...
                <div id="clgj_clh" class="clgj_tx">
                	<span>预算金额</span>
                    <input  name="note" type="text" placeholder="元" value="${ erpPaileiDetailsList[7].note}">
                </div>
            </li>
            <li>
            	<h2>个性化强电 <span>★</span></h2>
                ...
                <div id="clgj_qd" class="clgj_tx">
                	<span>预算金额</span>
                    <input name="note" type="text" placeholder="元" value="${ erpPaileiDetailsList[8].note}">
                </div>
            </li>
            <li>
            	<h2>灯位 <span>★</span></h2>
                ...
                <div id="clgj_dw" class="clgj_tx">
                	<span>预算金额</span>
                    <input name="note" type="text" placeholder="元" value="${ erpPaileiDetailsList[9].note}">
                </div>
            </li>
            <li>
            	<h2>阳台铺砖及吊顶  <span>★</span></h2>
                ...
                <div id="clgj_pwdd" class="clgj_tx">
                	<span>预算金额</span>
                    <input name="note" type="text" placeholder="元" value="${ erpPaileiDetailsList[10].note}">
                </div>
            </li>
            <li>
            	<h2>空调  </h2>
                <div class="clgj_xz">
                 <c:if test="${erpPaileiDetailsList[11].txtValue == erpPaileiDetailsList[11].firstValue}">
                   <input id="ktdk_yes" class="input_yes" name="12" type="radio" value="挂机" checked="checked">
                    <label for="ktdk_yes">挂机</label>
                    <input id="pwdd_no"  class="input_no" name="12" type="radio" value="柜机">
                    <label for="ktdk_no">柜机</label>	
                  </c:if>
                  <c:if test="${erpPaileiDetailsList[11].txtValue == erpPaileiDetailsList[11].secondValue}">
                     <input id="ktdk_yes" class="input_yes" name="12" type="radio" value="挂机">
                    <label for="ktdk_yes">挂机</label>
                    <input id="pwdd_no"  class="input_no" name="12" type="radio" value="柜机" checked="checked">
                    <label for="ktdk_no">柜机</label>
                  </c:if>
                ...
                <div class="clgj_xz">
                 <c:if test="${erpPaileiDetailsList[12].txtValue == erpPaileiDetailsList[12].firstValue}">
                   <input id="ktdk_yes" class="input_yes" name="13" type="radio" value="是" checked="checked">
                    <label for="ktdk_yes">是</label>
                    <input id="pwdd_no"  class="input_no" name="13" type="radio" value="否">
                    <label for="ktdk_no">否</label>	
                  </c:if>
                  <c:if test="${erpPaileiDetailsList[12].txtValue == erpPaileiDetailsList[12].secondValue}">
                     <input id="ktdk_yes" class="input_yes" name="13" type="radio" value="是">
                    <label for="ktdk_yes">是</label>
                    <input id="pwdd_no"  class="input_no" name="13" type="radio" value="否" checked="checked">
                    <label for="ktdk_no">否</label>
                  </c:if>
            ...
            <li>
            	<h2>个性化墙面  </h2>
                <div class="clgj_xz">
                   <c:if test="${erpPaileiDetailsList[13].txtValue == erpPaileiDetailsList[13].firstValue}">
                    <input id="qm_yes" class="input_yes" name="14" type="radio" value="有" checked="checked">
                    <label for="qm_yes">有</label>
                    <input id="qm_no" class="input_no" name="14" type="radio" value="无">
                    <label for="qm_no">无</label>
                  </c:if>
                  <c:if test="${erpPaileiDetailsList[13].txtValue == erpPaileiDetailsList[13].secondValue}">
                    <input id="qm_yes" class="input_yes" name="14" type="radio" value="有">
                    <label for="qm_yes">有</label>
                    <input id="qm_no" class="input_no" name="14" type="radio" value="无" checked="checked">
                    <label for="qm_no">无</label>
                  </c:if>
                   <c:if test="${empty erpPaileiDetailsList[13].txtValue and erpPaileiDetailsList[13].elementType eq 0}">
                    <input id="qm_yes" class="input_yes" name="14" type="radio" value="有">
                    <label for="qm_yes">有</label>
                    <input id="qm_no" class="input_no" name="14" type="radio" value="无">
                    <label for="qm_no">无</label>
                   ...
                   <input type="hidden" name="id"  value="${erpPaileiDetailsList[13].id}">
	             	<input type="hidden" name="txtValue"  value="${erpPaileiDetailsList[13].txtValue}">
	             	<input type="hidden" name="updateDate"  value="">
                </div>
                <div id="clgj_qm" class="clgj_tx">
                	<span>预算金额</span>
                    <input name="note" type="text" placeholder="元" value="${ erpPaileiDetailsList[13].note}">
                </div>
            </li>
            <li>
            	<h2>客厅电视是否壁挂 </h2>
                <div class="clgj_xz">
                   <c:if test="${erpPaileiDetailsList[14].txtValue == erpPaileiDetailsList[14].firstValue}">
                    <input id="dsbg_yes" class="input_yes" name="15" type="radio" value="挂" checked="checked">
                    <label for="dsbg_yes">挂</label>
                    <input id="dsbg_no" class="input_no" name="15" type="radio" value="不挂">
                    <label for="dsbg_no">不挂</label>	
                  </c:if>
                  <c:if test="${erpPaileiDetailsList[14].txtValue == erpPaileiDetailsList[14].secondValue}">
                   <input id="dsbg_yes" class="input_yes" name="15" type="radio" value="挂">
                    <label for="dsbg_yes">挂</label>
                    <input id="dsbg_no" class="input_no" name="15" type="radio" value="不挂" checked="checked">
                    <label for="dsbg_no">不挂</label>
                  </c:if>
                   <c:if test="${empty erpPaileiDetailsList[14].txtValue and erpPaileiDetailsList[14].elementType eq 0}">
                   <input id="dsbg_yes" class="input_yes" name="15" type="radio" value="挂">
                    <label for="dsbg_yes">挂</label>
                    <input id="dsbg_no" class="input_no" name="15" type="radio" value="不挂">
                    <label for="dsbg_no">不挂</label>
                    ...
                    <input type="hidden" name="id"  value="${erpPaileiDetailsList[14].id}">
	             	<input type="hidden" name="txtValue"  value="${erpPaileiDetailsList[14].txtValue}">
	             	<input type="hidden" name="updateDate"  value="">
                </div>
                <div id="clgj_dsbg" class="clgj_tx">
                	<span style="text-align:right">建议</span>
                    <input  name="note" type="text" value="${ erpPaileiDetailsList[14].note}">
                </div>
            </li>
            
        </ul>
        <h3>客户需求：</h3>
        <textarea name="txtValue" cols="" rows="" placeholder="请在此输入内容">${ erpPaileiDetailsList[15].txtValue}</textarea>
                    <input type="hidden" name="id"  value="${erpPaileiDetailsList[15].id}">
	             	<input type="hidden" name="note"  value="${erpPaileiDetailsList[15].note}">
	             	<input type="hidden" name="updateDate"  value="">
        <h3>设计师建议：</h3>
        <textarea name="txtValue" cols="" rows="" placeholder="请在此输入内容">${ erpPaileiDetailsList[16].txtValue}</textarea>
                    <input type="hidden" name="id"  value="${erpPaileiDetailsList[16].id}">
	             	<input type="hidden" name="note"  value="${erpPaileiDetailsList[16].note}">
	             	<input type="hidden" name="updateDate"  value="">
        <input class="clgj_nran" type="submit" value="保存">
        </form>
        </c:otherwise>
