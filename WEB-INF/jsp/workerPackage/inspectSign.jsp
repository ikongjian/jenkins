...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=NT4dlKcduR3zaDVc8vLzRR7m"></script><style type="text/css">
    .baidu_map {
        width: 100%;
        height: 100%;
        overflow: hidden;
...
<body>
	...
	<!--签到-->
	    <form id="signForm" action="/package/inspectUI" method="POST">
