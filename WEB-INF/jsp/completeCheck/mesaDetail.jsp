...
<style type="text/css">
	...
	.veiw_table .dataTR input.J_num {width:100%;}
    input[type=button] {
        margin-top: 1rem;
        width: 100%;
        height: 4.16rem;
...
<div class="content">
    <div class="title">
        <h2>收货明细</h2>
        <a href="/complete/check/threePath/inspect?orderNo=${result.erpEkko.legalContract}"><img src="/assets-new/img/esc.png"></a>
    </div>
    <hr class="content_hr">
    ...
    <form action="" method="post" enctype="multipart/form-data" id="detailForm">
        ...
        <input type="hidden" name="submitNumPen">
            ...
            <c:forEach items="${result.erpEkpos}" var="erpEkpo">
                <tr class="dataTR" data-id="${erpEkpo.id}">
                    ...
                    <td>
                     ...
                     <td>
                         <input class="J_num" type="text" value="${erpEkpo.ktmng}" data-oval="${erpEkpo.ktmng}" data-mlev="${erpEkpo.ktmng}" readonly="readonly">
                    </td>
                    <td>${erpEkpo.exlin}</td>
                </tr>
            </c:forEach>
                ...
                <tr class="penTR" data-mantr="${basin.matnr}" data-meins="${basin.meins}">
                    ...
                    <td>
                         <span class="Jian">-</span>
                         	<input class="J_num J_num_click" type="text" value="${basin.kmpmg}" data-oval="${basin.kmpmg}" data-mlev="${basin.kmpmg}">
                         <span class="Jia">+</span>
                    </td>
                    <td></td>
                </tr>
