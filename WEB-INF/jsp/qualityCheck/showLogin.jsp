...
<body>
	<div class="land">
	<form action="/qualityCheck/login" method="post" id="loginForm">
    	<i></i>
        <p>登录</p>
        <input class="land_sj" type="text" name="loginUserName" placeholder="请输入登录ERP的账号（姓名全拼）">
        <input class="land_mm"  name="loginPassword" type="password" placeholder="请输入密码">
        <p></p>
